package com.comandos.disposal.service;
...
public class DisposalService {
    ...
    private void dispose(DisposalProcess process, LineRequest line, List<Map<String, Object>> changes) {
        ...
        movement.location = item.location; movement.nature = StockMovementNature.DISPOSAL.name(); movement.referenceType = StockMovementReferenceType.DISPOSAL.name(); movement.referenceId = process.id; movement.quantity = item.quantity.negate();
