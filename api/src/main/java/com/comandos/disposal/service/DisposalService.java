...
public class DisposalService {
    ...
    private void dispose(DisposalProcess process, LineRequest line, List<Map<String, Object>> changes) {
        ...
        movement.location = item.location; movement.nature = StockMovementNature.DISPOSAL.name(); movement.referenceType = "DISPOSAL"; movement.referenceId = process.id; movement.quantity = item.quantity.negate();
