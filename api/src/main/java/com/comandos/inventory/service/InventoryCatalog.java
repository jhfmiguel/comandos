...
public final class InventoryCatalog {
    ...
    public static final List<Resource> RESOURCES = List.of(
        ...
        new Resource("assets", "Individual assets", "Inventory", AssetItem.class, List.of(
            ...
            new Field("condition", "Condition", "choice", true, null, java.util.Arrays.stream(AssetCondition.values()).map(Enum::name).toList(), false, false),
            new Field("status", "Availability", "choice", true, null, java.util.Arrays.stream(AssetStatus.values()).map(Enum::name).toList(), false, false),
            new Field("validUntil", "Valid until", "date", false, null, List.of(), false, false),
