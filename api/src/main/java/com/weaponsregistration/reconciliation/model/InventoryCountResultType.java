package com.weaponsregistration.reconciliation.model;

import com.weaponsregistration.core.model.CoreEntity;
import jakarta.persistence.*;

@Entity
@Table(name = "erp_inventory_count_result_type", uniqueConstraints = @UniqueConstraint(columnNames = "code"))
public class InventoryCountResultType extends CoreEntity {
