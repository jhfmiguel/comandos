package com.weaponsregistration.transfer.service;
...
import com.weaponsregistration.inventory.model.ItemCategory;
import com.weaponsregistration.inventory.model.StockBalance;
...
import com.weaponsregistration.transfer.dto.TransferContract.TransferView;
import com.weaponsregistration.transfer.model.InventoryTransfer;
import com.weaponsregistration.transfer.model.InventoryTransferItem;
...
public class TransferService {
    ...
    private void moveAsset(InventoryTransfer transfer, LineRequest line, StockLocation destination,
        ...
        StockMovement out = movement(asset, null, source, "TRANSFER_OUT", BigDecimal.ONE.negate(), transfer.sentAt);
        StockMovement in = movement(asset, null, destination, "TRANSFER_IN", BigDecimal.ONE, transfer.sentAt);
    ...
    private InventoryTransferItem item(InventoryTransfer transfer, com.weaponsregistration.inventory.model.ItemModel model,
