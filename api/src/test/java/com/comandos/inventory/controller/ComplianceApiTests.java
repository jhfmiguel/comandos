...
@SpringBootTest(webEnvironment=SpringBootTest.WebEnvironment.RANDOM_PORT,properties={"spring.datasource.url=jdbc:h2:mem:compliance-tests;MODE=Oracle;DB_CLOSE_DELAY=-1","logging.level.root=WARN","debug=false"})class ComplianceApiTests{
