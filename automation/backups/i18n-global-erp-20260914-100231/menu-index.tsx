                            ...
                            <Sidebar.MenuItem>
                                ...
                                >
                                    ...
                                    <PopupMenu.Trigger
                                        ...
                                        aria-label={tr(tr(tr("Open user menu")))}
                                    >
                                        ...
                                        >
                                            ...
                                            <PopupMenu.Popup className="comandos-sidebar-user-popup">
                                                ...
                                                <PopupMenu.List>
                                                    ...
                                                    <PopupMenu.Label>
                                                        {session?.user?.login || tr(tr("Setup mode"))}
                                                    </PopupMenu.Label>
                                                    ...
                                                    {session?.user ? <PopupMenu.Item disabled={signingOut}
                                                        ...
                                                        <SignOut />{signingOut ? tr(tr("Signing out…")) : tr(tr("Sign out"))}
                                                    </PopupMenu.Item> : <PopupMenu.Item as={Link} href="/login"><SignOut />{tr(tr("Sign in"))}</PopupMenu.Item>}
